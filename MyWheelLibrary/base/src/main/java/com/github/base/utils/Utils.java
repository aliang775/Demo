...
public final class Utils {
    ...
    static class ActivityLifecycleImpl implements ActivityLifecycleCallbacks {
        ...
        public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
            FmLog.Companion.i(TAG, "ActivityCreated : " + activity.getClass().getSimpleName());
            setTopActivity(activity);
        }

        @Override
        public void onActivityStarted(Activity activity) {
            FmLog.Companion.i(TAG, "ActivityStarted : " + activity.getClass().getSimpleName());
            if (!mIsBackground) {
                setTopActivity(activity);
            }
            if (mConfigCount < 0) {
        ...
        public void onActivityResumed(Activity activity) {
            FmLog.Companion.i(TAG, "ActivityResumed : " + activity.getClass().getSimpleName());
            setTopActivity(activity);
            if (mIsBackground) {
                mIsBackground = false;
                postStatus(true);
        ...
        public void onActivityPaused(Activity activity) {/**/
            FmLog.Companion.i(TAG, "ActivityPaused : " + activity.getClass().getSimpleName());
        }

        @Override
        public void onActivityStopped(Activity activity) {
            FmLog.Companion.i(TAG, "ActivityStopped : " + activity.getClass().getSimpleName());
        ...
        public void onActivitySaveInstanceState(Activity activity, Bundle outState) {
            FmLog.Companion.i(TAG, "ActivitySaveInstanceState : " + activity.getClass().getSimpleName());
        }

        @Override
        public void onActivityDestroyed(Activity activity) {
            FmLog.Companion.i(TAG, "ActivityDestroyed : " + activity.getClass().getSimpleName());
        ...
        private void postStatus(final boolean isForeground) {
            FmLog.Companion.i(TAG, isForeground ? "foreground" : "background");
